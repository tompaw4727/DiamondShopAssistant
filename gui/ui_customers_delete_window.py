...
"}")
        ...
        self.label_2.setGeometry(QRect(40, 0, 261, 51))
...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_2.setText(QCoreApplication.translate("Form", u"<html><head/><body><p><span style=\" font-size:18pt;\">Delete a customer with ID:</span></p></body></html>", None))
    # retranslateUi
